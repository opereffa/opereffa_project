...
public final class Test {
  ...
  public interface PersonOrBuilder
    ...
    java.util.List<Test.Person.PhoneNumber> 
        getPhoneList();
    Test.Person.PhoneNumber getPhone(int index);
    int getPhoneCount();
    java.util.List<? extends Test.Person.PhoneNumberOrBuilder> 
        getPhoneOrBuilderList();
    Test.Person.PhoneNumberOrBuilder getPhoneOrBuilder(
        int index);
  }
  public static final class Person extends
    ...
    public static final class PhoneNumber extends
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Test.internal_static_tutorial_Person_PhoneNumber_descriptor;
      }
      
      protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return Test.internal_static_tutorial_Person_PhoneNumber_fieldAccessorTable;
      }
      ...
      private Test.Person.PhoneType type_;
      ...
      private void initFields() {
        number_ = "";
        type_ = Test.Person.PhoneType.HOME;
      }
      ...
      public static final class Builder extends
         ...
         implements Test.Person.PhoneNumberOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
          return Test.internal_static_tutorial_Person_PhoneNumber_descriptor;
        }
        ...
        public com.google.protobuf.Descriptors.Descriptor
            getDescriptorForType() {
          return Test.Person.PhoneNumber.getDescriptor();
        }
        ...
        private Test.Person.PhoneNumber buildParsed()
            throws com.google.protobuf.InvalidProtocolBufferException {
          Test.Person.PhoneNumber result = buildPartial();
          if (!result.isInitialized()) {
          ...
          while (true) {
            ...
            switch (tag) {
              ...
              case 16: {
                ...
                Test.Person.PhoneType value = Test.Person.PhoneType.valueOf(rawValue);
                if (value == null) {
  ...
  bitField0_ |= 0x00000001;
        ...
        // optional .Person.PhoneType type = 2 [default = HOME];
        private Test.Person.PhoneType type_ = Test.Person.PhoneType.HOME;
        public boolean hasType() {
          return ((bitField0_ & 0x00000002) == 0x00000002);
        }
        public Test.Person.PhoneType getType() {
    ...
    private java.util.List<Test.Person.PhoneNumber> phone_;
    public java.util.List<Test.Person.PhoneNumber> getPhoneList() {
      return phone_;
    }
    ...
    public Test.Person.PhoneNumber getPhone(int index) {
      return phone_.get(index);
    }
    public Test.Person.PhoneNumberOrBuilder getPhoneOrBuilder(
        int index) {
      return phone_.get(index);
    }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements Test.PersonOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Test.internal_static_tutorial_Person_descriptor;
      }
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 34: {
              Test.Person.PhoneNumber.Builder subBuilder = Test.Person.PhoneNumber.newBuilder();
  ...
  bitField0_ |= 0x00000004;
      ...
      private void ensurePhoneIsMutable() {
        if (!((bitField0_ & 0x00000008) == 0x00000008)) {
          phone_ = new java.util.ArrayList<Test.Person.PhoneNumber>(phone_);
          bitField0_ |= 0x00000008;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          Test.Person.PhoneNumber, Test.Person.PhoneNumber.Builder, Test.Person.PhoneNumberOrBuilder> phoneBuilder_;
      ...
      public Builder addPhone(Test.Person.PhoneNumber value) {
        if (phoneBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Test.Person.PhoneNumber.Builder getPhoneBuilder(
          int index) {
      ...
      public Test.Person.PhoneNumber.Builder addPhoneBuilder() {
  ...
  public interface AddressBookOrBuilder
    ...
    java.util.List<Test.Person> 
        getPersonList();
    Test.Person getPerson(int index);
    int getPersonCount();
  ...
  public static final class AddressBook extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Test.internal_static_tutorial_AddressBook_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Test.internal_static_tutorial_AddressBook_fieldAccessorTable;
    }
    
    // repeated .Person person = 1;
    public static final int PERSON_FIELD_NUMBER = 1;
    private java.util.List<Test.Person> person_;
    public java.util.List<Test.Person> getPersonList() {
      return person_;
    }
    ...
    public Test.Person getPerson(int index) {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements Test.AddressBookOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Test.internal_static_tutorial_AddressBook_descriptor;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return Test.AddressBook.getDescriptor();
      }
      ...
      private Test.AddressBook buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        Test.AddressBook result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 10: {
              Test.Person.Builder subBuilder = Test.Person.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
      ...
      private void ensurePersonIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          person_ = new java.util.ArrayList<Test.Person>(person_);
          bitField0_ |= 0x00000001;
         }
      }
      ...
      public Builder addPerson(Test.Person value) {
        if (personBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Test.Person.Builder addPersonBuilder() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "one\030\004 \003(\0132\034.Person.PhoneNumber\032" +
      "M\n\013PhoneNumber\022\016\n\006number\030\001 \002(\t\022.\n\004type\030\002" +
      " \001(\0162\032.Person.PhoneType:\004HOME\"+" +
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_tutorial_Person_PhoneNumber_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              Test.Person.PhoneNumber.class,
              Test.Person.PhoneNumber.Builder.class);
          internal_static_tutorial_AddressBook_descriptor =
          ...
          internal_static_tutorial_AddressBook_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              Test.AddressBook.Builder.class);
          return null;
        }
      };
