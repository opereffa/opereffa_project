...
public abstract class ItemStructureWrapper extends EHRStructureWrapper {
	
	protected ArchetypeWrapper containerArchetype;	
	
	public String getItemStructureTypeName(){
		return ccomplexReference.getRmTypeName();
	}
	
	protected abstract void processItemStructureWrapper() throws Exception;
