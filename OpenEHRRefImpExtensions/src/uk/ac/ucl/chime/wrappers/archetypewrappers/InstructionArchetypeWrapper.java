...
public class InstructionArchetypeWrapper extends ArchetypeWrapper {
	
	public InstructionArchetypeWrapper(Archetype pArchetype, ArchetypeWrapperFactory pFactory) throws Exception{
		initArchetypeWrapper(pArchetype, pFactory);
	}
	
	public InstructionArchetypeWrapper(Archetype pArchetype, ArchetypeWrapperFactory pFactory, boolean pIsInSlot) throws Exception{
		isInSlot = pIsInSlot;
		initArchetypeWrapper(pArchetype, pFactory);
	}
	...
	protected void initArchetypeWrapper(Archetype pArchetype,
		...
		rootWrapper = new InstructionWrapper(definition, this, this);
