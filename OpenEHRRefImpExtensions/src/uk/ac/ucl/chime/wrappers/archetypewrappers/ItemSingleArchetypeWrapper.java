...
public class ItemSingleArchetypeWrapper extends ArchetypeWrapper {
	
	public ItemSingleArchetypeWrapper(Archetype pArchetype, ArchetypeWrapperFactory pFactory) throws Exception{
		initArchetypeWrapper(pArchetype, pFactory);
	}
	
	public ItemSingleArchetypeWrapper(Archetype pArchetype, ArchetypeWrapperFactory pFactory, boolean pIsInSlot) throws Exception{
		isInSlot = pIsInSlot;
		initArchetypeWrapper(pArchetype, pFactory);
	}
...
//		rootWrapper = new ItemSingleWrapper(definition, this);
