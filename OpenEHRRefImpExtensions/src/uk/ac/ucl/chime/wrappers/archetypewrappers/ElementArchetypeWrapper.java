...
public class ElementArchetypeWrapper extends ArchetypeWrapper {

	public ElementArchetypeWrapper(Archetype pArchetype, ArchetypeWrapperFactory pFactory) throws Exception{
		initArchetypeWrapper(pArchetype, pFactory);
	}
	
	public ElementArchetypeWrapper(Archetype pArchetype, ArchetypeWrapperFactory pFactory, boolean pIsInSlot) throws Exception{
		isInSlot = pIsInSlot;
		initArchetypeWrapper(pArchetype, pFactory);
	}
	...
	protected void initArchetypeWrapper(Archetype pArchetype,
		...
		ElementWrapperFactory factory = new ElementWrapperFactory(definition, this, false, this);
		rootWrapper = factory.getElementWrapperInstance();
