...
public class ItemTreeArchetypeWrapper extends ArchetypeWrapper {
	
	public ItemTreeArchetypeWrapper(Archetype pArchetype, ArchetypeWrapperFactory pFactory) throws Exception{
		initArchetypeWrapper(pArchetype, pFactory);
	}
	
	public ItemTreeArchetypeWrapper(Archetype pArchetype, ArchetypeWrapperFactory pFactory, boolean pIsInSlot) throws Exception{
		isInSlot = pIsInSlot;
		initArchetypeWrapper(pArchetype, pFactory);
	}
	...
	protected void initArchetypeWrapper(Archetype pArchetype,
		...
		rootWrapper = new ItemTreeWrapper(definition, this, null);
