...
public final class DVDATE implements Externalizable, Message<DVDATE>
{

    public static Schema<DVDATE> getSchema()
    {
        return SCHEMA;
    }

    public static DVDATE getDefaultInstance()
    {
        return DEFAULT_INSTANCE;
    }

    static final DVDATE DEFAULT_INSTANCE = new DVDATE();
    ...
    public Schema<DVDATE> cachedSchema()
    {
        return SCHEMA;
    }

    static final Schema<DVDATE> SCHEMA = new Schema<DVDATE>()
    {
        // schema methods

        public DVDATE newMessage()
        {
            return new DVDATE();
        }

        public Class<DVDATE> typeClass()
        {
            return DVDATE.class;
        }
        ...
        {
            return DVDATE.class.getSimpleName();
        }

        public String messageFullName()
        {
            return DVDATE.class.getName();
        }

        public boolean isInitialized(DVDATE message)
        {
            return 
                message.value != null;
        }

        public void mergeFrom(Input input, DVDATE message) throws IOException
        {
        ...
        public void writeTo(Output output, DVDATE message) throws IOException
        {
