...
public final class TERMBINDINGITEM implements Externalizable, Message<TERMBINDINGITEM>
{
    ...
    static final Schema<TERMBINDINGITEM> SCHEMA = new Schema<TERMBINDINGITEM>()
    {
        // schema methods
