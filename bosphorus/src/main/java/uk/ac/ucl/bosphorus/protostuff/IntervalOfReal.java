...
public final class IntervalOfReal implements Externalizable, Message<IntervalOfReal>
{

    public static Schema<IntervalOfReal> getSchema()
    {
        return SCHEMA;
    }

    public static IntervalOfReal getDefaultInstance()
    {
        return DEFAULT_INSTANCE;
    }

    static final IntervalOfReal DEFAULT_INSTANCE = new IntervalOfReal();
    ...
    public Schema<IntervalOfReal> cachedSchema()
    {
        return SCHEMA;
    }

    static final Schema<IntervalOfReal> SCHEMA = new Schema<IntervalOfReal>()
    {
        // schema methods

        public IntervalOfReal newMessage()
        {
            return new IntervalOfReal();
        }

        public Class<IntervalOfReal> typeClass()
        {
            return IntervalOfReal.class;
        }

        public String messageName()
        {
            return IntervalOfReal.class.getSimpleName();
        }

        public String messageFullName()
        {
            return IntervalOfReal.class.getName();
        }

        public boolean isInitialized(IntervalOfReal message)
        {
            return true;
        }

        public void mergeFrom(Input input, IntervalOfReal message) throws IOException
        {
        ...
        public void writeTo(Output output, IntervalOfReal message) throws IOException
        {
