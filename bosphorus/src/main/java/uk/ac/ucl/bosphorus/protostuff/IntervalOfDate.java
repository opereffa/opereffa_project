...
public final class IntervalOfDate implements Externalizable, Message<IntervalOfDate>
{

    public static Schema<IntervalOfDate> getSchema()
    {
        return SCHEMA;
    }

    public static IntervalOfDate getDefaultInstance()
    {
        return DEFAULT_INSTANCE;
    }

    static final IntervalOfDate DEFAULT_INSTANCE = new IntervalOfDate();
    ...
    public Schema<IntervalOfDate> cachedSchema()
    {
        return SCHEMA;
    }

    static final Schema<IntervalOfDate> SCHEMA = new Schema<IntervalOfDate>()
    {
        // schema methods

        public IntervalOfDate newMessage()
        {
            return new IntervalOfDate();
        }

        public Class<IntervalOfDate> typeClass()
        {
            return IntervalOfDate.class;
        }

        public String messageName()
        {
            return IntervalOfDate.class.getSimpleName();
        }

        public String messageFullName()
        {
            return IntervalOfDate.class.getName();
        }

        public boolean isInitialized(IntervalOfDate message)
        {
            return true;
        }

        public void mergeFrom(Input input, IntervalOfDate message) throws IOException
        {
        ...
        public void writeTo(Output output, IntervalOfDate message) throws IOException
        {
