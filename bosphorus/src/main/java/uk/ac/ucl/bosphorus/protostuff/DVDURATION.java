...
public final class DVDURATION implements Externalizable, Message<DVDURATION>
{
    ...
    static final Schema<DVDURATION> SCHEMA = new Schema<DVDURATION>()
    {
        // schema methods
        ...
        public String getFieldName(int number)
        {
            switch(number)
            {
                ...
                case 7: return "accuracyispercent";
                default: return null;
            }
        }
        ...
        final java.util.HashMap<String,Integer> fieldMap = new java.util.HashMap<String,Integer>();
        {
            ...
            fieldMap.put("accuracyispercent", 7);
        }
    };
