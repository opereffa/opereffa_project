...
public final class IntervalOfDuration implements Externalizable, Message<IntervalOfDuration>
{
    ...
    static final Schema<IntervalOfDuration> SCHEMA = new Schema<IntervalOfDuration>()
    {
        // schema methods
